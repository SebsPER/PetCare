        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessName = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndTime = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    Veteryname = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    ProductTypeName = table.Column<string>(type: "varchar(15)", maxLength: 15, nullable: false),
                    BusinessId = table.Column<int>(type: "int", nullable: false),
                    PersonProfileId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VetName = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
